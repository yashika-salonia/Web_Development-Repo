//THIS in function => this. used in the function return the values in context with that function
const user={
    name: 'sam',
    age: 23,
    ...
    attnMsg: function(){
        ...
        console.log(this); //Output will return all the keys: values, that belong to the user in the object format
    }
}
